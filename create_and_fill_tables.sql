...
(9,'Cooper','Kassulke','2018-11-27',9971,'',3,3),
(10,'Bernadette','Adams','2022-10-22',9794,'schroeder.germaine@example.net',4,4),
(11,'Amanita','Brown','2022-11-22',3794,'amanita.germaine@example.net',4,4);

ALTER TABLE departments
ADD constraint departments_manager_id_constaint
